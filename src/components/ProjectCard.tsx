...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all hover:-translate-y-1 hover:border-ink hover:shadow-[6px_6px_0_0_var(--color-accent)]"
    >
      <div>
