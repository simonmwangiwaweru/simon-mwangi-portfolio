    ...
    <section id="about" className="border-t border-border bg-card">
      <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
        ...
        <p className="mt-6 max-w-3xl font-display text-2xl font-medium leading-snug tracking-tight sm:text-3xl">
          ...
          problems — from USSD-accessible marketplaces to AI tools for small
          businesses. Comfortable across the stack and increasingly focused
          on AI/ML engineering. I started out designing posters with zero
          capital and grew into shipping full software.
        </p>
      </div>
    </section>
  );
